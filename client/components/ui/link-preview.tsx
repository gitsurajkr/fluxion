...
type LinkPreviewProps = {
  ...
  | { isStatic: true; imageSrc: string | undefined }
...
export const LinkPreview = ({
  ...
  if (!src) return <span className={className}>{children}</span>; // no preview image
          ...
          {isOpen && (
            ...
            >
              <a
                ...
                style={{ fontSize: 0 }}
              >
                <img src={src} width={width} height={height} className="rounded-lg" alt="preview image" />
              </a>
            </motion.div>
          )}
        </AnimatePresence>
